...
| 下载格式 | 默认CAJ，无法指定 | **智能识别PDF链接，优先下载PDF** |
...
| 📄 **优先PDF格式** | 智能识别PDF链接，自动将CAJ链接转换为PDF格式下载 |
...
<details>
<summary><b>下载的是CAJ不是PDF？</b></summary>
v8.3 已优化，自动优先查找PDF下载链接。如果某篇文献仍下载CAJ，说明该文献在知网上仅提供CAJ格式。
</details>
...
### v8.2
- ✅ 优先PDF下载：智能识别PDF链接，CAJ链接自动转换PDF格式
- ✅ 中场休息可跳过：一键跳过，立即继续下载
